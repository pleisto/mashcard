...
module System
  class Queries::Spaces < BrickGraphQL::BaseResolver
    ...
    def resolve
      ...
      spaces.map do |space|
        ...
        space.space_attributes.merge(email: current_user.email, owned: is_owner, invite_secret: is_owner ? space.invite_secret : nil)
      end
    end
  end
end
