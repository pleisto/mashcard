...
/// Fastest is_blank implementation.
/// ref: https://github.com/matsadler/magnus/blob/main/examples/rust_blank/ext/rust_blank/src/lib.rs
...
pub fn init() -> Result<(), Error> {
    ...
    r_str.define_method("blank?", method!(is_blank, 0))?;
    Ok(())
}
