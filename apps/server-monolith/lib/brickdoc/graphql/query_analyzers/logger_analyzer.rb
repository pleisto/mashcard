...
module Brickdoc
  module GraphQL
    module QueryAnalyzers
      # This analyzer logs the query and its complexity.
      # @see https://graphql-ruby.org/queries/ast_analysis
      class LoggerAnalyzer < ::GraphQL::Analysis::AST::QueryComplexity
