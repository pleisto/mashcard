  ...
  module Settings
    module DSL
      ...
      def namespace(*namespace, &block)
        ...
        Mashcard::Settings::Accessor.new(self, namespace: namespace).with_block(&block)
      end
      ...
      def at(user_id: nil, pod_id: nil, &block)
        Mashcard::Settings::Accessor.new(self, user_id: user_id, pod_id: pod_id).with_block(&block)
      end
