...
module FactoryBot
  ...
  def self.register_strategy(*, **, &); end
  def self.reload; end
...
module FactoryBot::Internal
  ...
  def self.constructor(*, **, &); end
  def self.factories(*, **, &); end
  def self.factory_by_name(name); end
  def self.initialize_with(*, **, &); end
  def self.inline_sequences(*, **, &); end
...
class FactoryBot::Factory
  def add_callback(*, **, &); end
  def append_traits(*, **, &); end
  ...
  def constructor(*, **, &); end
  def declare_attribute(*, **, &); end
  def define_trait(*, **, &); end
  def defined_traits(*, **, &); end
  def definition; end
  def evaluator_class; end
  def hierarchy_class; end
...
class FactoryBot::Enum
  ...
  def initialize(attribute_name, values = nil); end
end
...
class FactoryBot::DefinitionProxy
  ...
  def traits_for_enum(attribute_name, values = nil); end
