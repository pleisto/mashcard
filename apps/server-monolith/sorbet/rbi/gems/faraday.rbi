...
class Faraday::RequestOptions < Anonymous_Faraday_Options_29
  def []=(key, value); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_30
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_31
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_32
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_33 < Faraday::Options
  def method; end
  def method=(_); end
  def parallel_manager; end
  def parallel_manager=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_33
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_34
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
