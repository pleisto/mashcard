...
module PG::BasicTypeRegistry::Checker
  def build_coder_maps(conn_or_maps, registry: nil); end
  def check_format_and_direction(format, direction); end
end
class PG::BasicTypeMapBasedOnResult < PG::TypeMapByOid
  def initialize(connection_or_coder_maps, registry: nil); end
  include PG::BasicTypeRegistry::Checker
end
class PG::BasicTypeMapForQueries < PG::TypeMapByClass
  ...
  def initialize(connection_or_coder_maps, registry: nil, if_undefined: nil); end
  def populate_encoder_list; end
  def undefined(name, format); end
  include PG::BasicTypeRegistry::Checker
end
class PG::BasicTypeMapForQueries::BinaryData < String
end
class PG::BasicTypeMapForQueries::UndefinedEncoder < RuntimeError
end
