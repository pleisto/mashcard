...
RSpec.describe Docs::Block, type: :model do
  it 'normal' do
    ...
    _sub_block1 = create(:docs_block, text: title, space: block.space, parent: block, id: Brickdoc::Utils::Encoding::UUID.gen_v4)
    _sub_block2 = create(:docs_block, text: title, space: block.space, parent: block, id: Brickdoc::Utils::Encoding::UUID.gen_v4)
  ...
  it 'soft delete' do
    ...
    sub_block1 = create(:docs_block, space: block.space, parent: block, id: Brickdoc::Utils::Encoding::UUID.gen_v4)
    _sub_block2 = create(:docs_block, space: block.space, parent: block, id: Brickdoc::Utils::Encoding::UUID.gen_v4)
