...
RSpec.describe MashcardConfig, type: :model do
  before do
    Rails.cache.clear
  end
  ...
  it 'can handle settings on different context' do
    ...
    expect { described_class.domains_test2 = 1 }.to raise_error(Mashcard::Settings::Errors::NotFoundField)
  ...
  it 'field type should work' do
    ...
    expect { type_test.set(:ro_val, 'y') }.to raise_error(Mashcard::Settings::Errors::ReadOnlyField)
