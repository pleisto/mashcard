...
export type CreateDirectUploadMutation = { __typename?: 'RootMutation' } & {
  createDirectUpload?: Maybe<
    { __typename?: 'CreateDirectUploadPayload' } & Pick<CreateDirectUploadPayload, 'urlPrefix'> & {
        directUpload: { __typename?: 'DirectUpload' } & Pick<DirectUpload, 'url' | 'headers' | 'blobKey' | 'signedBlobId'>
      }
  >
}
