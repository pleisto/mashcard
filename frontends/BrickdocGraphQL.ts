...
/**
 * __useGetPodUsersQuery__
 *
 * To run a query within a React component, call `useGetPodUsersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPodUsersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPodUsersQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetPodUsersQuery(baseOptions?: Apollo.QueryHookOptions<GetPodUsersQuery, GetPodUsersQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetPodUsersQuery, GetPodUsersQueryVariables>(GetPodUsersDocument, options)
}
export function useGetPodUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPodUsersQuery, GetPodUsersQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetPodUsersQuery, GetPodUsersQueryVariables>(GetPodUsersDocument, options)
}
export type GetPodUsersQueryHookResult = ReturnType<typeof useGetPodUsersQuery>
export type GetPodUsersLazyQueryHookResult = ReturnType<typeof useGetPodUsersLazyQuery>
export type GetPodUsersQueryResult = Apollo.QueryResult<GetPodUsersQuery, GetPodUsersQueryVariables>
