...
/** Autogenerated input type of PodDestroy */
...
/** Autogenerated input type of PodLeave */
export type PodLeaveInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>
  /** User webid */
  userWebid: Scalars['String']
  /** Pod webid */
  webid: Scalars['String']
}
...
export type RootMutation = {
  ...
  updateWebid?: Maybe<UpdateWebidPayload>
...
export type RootMutationUpdateWebidArgs = {
  input: UpdateWebidInput
}
...
/** Autogenerated input type of UpdateWebid */
export type UpdateWebidInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>
  /** new webid */
  newWebid: Scalars['String']
  /** current webid */
  webid: Scalars['String']
}

/** Autogenerated return type of UpdateWebid */
export type UpdateWebidPayload = {
  __typename?: 'UpdateWebidPayload'
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>
  /** Errors encountered during execution of the mutation. */
  errors: Array<Scalars['String']>
...
export type BlockDuplicateMutation = {
  __typename?: 'RootMutation'
  blockDuplicate?: { __typename?: 'BlockDuplicatePayload'; id: string; errors: Array<string> } | null
}
...
export type FormulaCreateMutation = {
  __typename?: 'RootMutation'
  formulaCreate?: { __typename?: 'FormulaCreatePayload'; errors: Array<string> } | null
}
...
export type FormulaUpdateMutation = {
  __typename?: 'RootMutation'
  formulaUpdate?: { __typename?: 'FormulaUpdatePayload'; errors: Array<string> } | null
}
...
export type FormulaDeleteMutation = {
  __typename?: 'RootMutation'
  formulaDelete?: { __typename?: 'FormulaDeletePayload'; errors: Array<string> } | null
}
...
export type UpdateWebidMutationVariables = Exact<{
  input: UpdateWebidInput
}>

export type UpdateWebidMutation = {
  __typename?: 'RootMutation'
  updateWebid?: { __typename?: 'UpdateWebidPayload'; errors: Array<string> } | null
}
...
>
export const UpdateWebidDocument = gql`
...
`
export type UpdateWebidMutationFn = Apollo.MutationFunction<UpdateWebidMutation, UpdateWebidMutationVariables>

/**
 * __useUpdateWebidMutation__
 *
 * To run a mutation, you first call `useUpdateWebidMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateWebidMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateWebidMutation, { data, loading, error }] = useUpdateWebidMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateWebidMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateWebidMutation, UpdateWebidMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<UpdateWebidMutation, UpdateWebidMutationVariables>(UpdateWebidDocument, options)
}
export type UpdateWebidMutationHookResult = ReturnType<typeof useUpdateWebidMutation>
export type UpdateWebidMutationResult = Apollo.MutationResult<UpdateWebidMutation>
export type UpdateWebidMutationOptions = Apollo.BaseMutationOptions<UpdateWebidMutation, UpdateWebidMutationVariables>
