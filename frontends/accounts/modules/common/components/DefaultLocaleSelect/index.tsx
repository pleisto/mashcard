...
const DefaultLocaleSelect:React.FC<DefaultLocaleSelectProps> = (props) => {
  ...
  return <div className={styles.root}>
    <International />
    <Select defaultValue={props.currentLocale}
            virtual={false}
            ...
            bordered={false} options={data.metadata.availableLocales} />
  </div>
}

export default DefaultLocaleSelect
