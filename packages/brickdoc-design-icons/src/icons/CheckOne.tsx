...
export default IconWrapper('check-one', false, (props: ISvgIconProps) => (
  <svg fill="none" viewBox="0 0 24 24">
    ...
    />
    <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" stroke={props.colors[0]} d="m8 12 3 3 6-6" />
  </svg>
))
