...
export default IconWrapper('help', true, (props: ISvgIconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    />
    <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" stroke="#3E3E3E" d="M12 14.313v-2a3 3 0 1 0-3-3" />
    <path fill="#3E3E3E" d="M12 18.813a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5z" clipRule="evenodd" fillRule="evenodd" />
  </svg>
))
