...
export default IconWrapper('redo', false, (props: ISvgIconProps) => (
  <svg viewBox="0 0 24 24" fill="none">
    ...
    />
    <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" stroke={props.colors[0]} d="M21 4v4.5h-4.5" />
  </svg>
))
