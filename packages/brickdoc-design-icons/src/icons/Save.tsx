...
export default IconWrapper('save', false, (props: ISvgIconProps) => (
  <svg viewBox="0 0 24 24" fill="none">
    ...
    />
    <path strokeLinejoin="round" strokeWidth="2" stroke={props.colors[0]} d="M16 3v9H7.5V3H16z" />
    <path strokeLinecap="round" strokeWidth="2" stroke={props.colors[0]} d="M13 6.5v2M5.498 3H18" />
  </svg>
))
