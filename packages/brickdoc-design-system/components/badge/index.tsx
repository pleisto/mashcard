...
const Badge: CompoundedComponent = ({
  ...
  // ================================ Misc ================================
  const numberedDisplayCount = // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
  ((count as number) > (overflowCount as number) ? `${overflowCount}+` : count) as string | number | null
