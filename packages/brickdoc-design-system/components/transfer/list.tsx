...
> extends React.PureComponent<TransferListProps<RecordType>, TransferListState> {
  ...
  getFilteredItems(
    dataSource: RecordType[],
    filterValue: string,
  ): { filteredItems: RecordType[]; filteredRenderItems: Array<RenderedItem<RecordType>> } {
    const filteredItems: RecordType[] = []
    const filteredRenderItems: Array<RenderedItem<RecordType>> = []
  ...
  getListBody(
    ...
    filteredRenderItems: Array<RenderedItem<RecordType>>,
    checkedKeys: string[],
    renderList?: RenderListFunction<RecordType>,
    showSearch?: boolean,
    disabled?: boolean,
  ...
  getCheckBox(
    ...
    const checkAllCheckbox = showSelectAll && (
      <Checkbox
        disabled={disabled}
        checked={checkedAll}
