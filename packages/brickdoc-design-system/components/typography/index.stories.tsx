...
const Template: Story = (_args) => {
  ...
  return(<Typography>
    ...
    <br/><br/>
    <p><Text>BrickDesign (default)</Text></p>
    <p><Text type='secondary'>BrickDesign (secondary)</Text></p>
    <p><Text type='success'>BrickDesign (success)</Text></p>
    <p><Text type='warning'>BrickDesign (warning)</Text></p>
    <p><Text type='danger'>BrickDesign (danger)</Text></p>
    <p><Text disabled>BrickDesign (disabled)</Text></p>
    <p><Text mark>BrickDesign (mark)</Text></p>
    <p><Text code>BrickDesign (code)</Text></p>
    <p><Text keyboard>BrickDesign (keyboard)</Text></p>
    <p><Text underline>BrickDesign (underline)</Text></p>
    <p><Text delete>BrickDesign (delete)</Text></p>
    <p><Text strong>BrickDesign (strong)</Text></p>
