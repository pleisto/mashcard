...
| locale | The i18n text including filter, sort, empty text, etc | object | filterConfirm: `Ok`  filterReset: `Reset`  emptyText: `No Data`  [Default](https://github.com/ant-design/ant-design/blob/4ad1ccac277782d7ed14f7e5d02d6346aae0db67/components/locale/default.tsx#L19)         |
...
import { Base } from '../components/table/demos'
