      ...
      <Popover
        ...
        content={
          <Menu className="table-block-menu">
            <Menu.Item itemKey="Filter" className="table-block-menu-item input-item">
              <Input onChange={handleFilterChange} placeholder="Filter actions..." />
            </Menu.Item>
