...
export const FileIcon: React.FC<FileIconProps> = ({ fileType, className }) => {
  ...
  if (fileType === 'pdf')
    return <img className={cx('brickdoc-link-block-attachment-img-icon', className)} alt="" src={IconPdf} />
  if (fileType === 'excel')
    return <img className={cx('brickdoc-link-block-attachment-img-icon', className)} alt="" src={IconExcel} />
  if (fileType === 'ppt')
    return <img className={cx('brickdoc-link-block-attachment-img-icon', className)} alt="" src={IconPpt} />
  if (fileType === 'word')
    return <img className={cx('brickdoc-link-block-attachment-img-icon', className)} alt="" src={IconWord} />
