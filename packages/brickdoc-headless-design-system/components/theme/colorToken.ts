export const ColorToken = {
  ...
  'color-divider-thirdary': 'fade($black,10%)',

  'color-overlays-primary-hover': 'fade($black,5%)',
  'color-overlays-primary-pressed': 'fade($black,10%)',
  'color-overlays-secondary-hover': 'fade($white,90%)',
  'color-overlays-secondary-pressed': 'fade($black,12%)',
