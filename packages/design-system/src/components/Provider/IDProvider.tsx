...
// SSR case multiple copies of @mashcard/design-system is not supported.
...
/**
 * When using SSR with MashCard design system, applications must be wrapped in an IDProvider.
