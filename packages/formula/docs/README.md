...
• `Const` **requestGet**: [`FunctionClause`](interfaces/FunctionClause.md)<``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"``, ``true``, ``false``, ``false``, [{ `name`: `string` = 'url'; `type`: ``"string"`` = 'string' }]\>
...
| Name | Type |
| :------ | :------ |
| `Return` | extends ``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"`` \| readonly [``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"``, ``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"``] |
| `Async` | extends `boolean` |
| `Chain` | extends `boolean` |
| `AcceptError` | extends `boolean` |
| `Arguments` | extends [...args: (Chain extends true ? [firstArgs: Argument<"string" \| "number" \| "boolean" \| "Block" \| "null" \| "Date" \| "Blank" \| "Record" \| "Array" \| "Error" \| "Spreadsheet" \| "Row" \| "Cell" \| "Column" \| "Range" \| "Cst" \| "Reference" \| "Function" \| "Predicate" \| "Button" \| "Switch" \| "literal" \| "Pending" \| "Waiting" \| "NoPersist"\>, ...args: Argument<"string" \| "number" \| "boolean" \| "Block" \| "null" \| "Date" \| "Blank" \| "Record" \| "Array" \| "Error" \| "Spreadsheet" \| "Row" \| "Cell" \| "Column" \| "Range" \| "Cst" \| "Reference" \| "Function" \| "Predicate" \| "Button" \| "Switch" \| "literal" \| "Pending" \| "Waiting" \| "NoPersist"\>[]] : Argument<"string" \| "number" \| "boolean" \| "Block" \| "null" \| "Date" \| "Blank" \| "Record" \| "Array" \| "Error" \| "Spreadsheet" \| "Row" \| "Cell" \| "Column" \| "Range" \| "Cst" \| "Reference" \| "Function" \| "Predicate" \| "Button" \| "Switch" \| "literal" \| "Pending" \| "Waiting" \| "NoPersist"\>[])[]] |
| `RealReturn` | extends ``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"`` = `FlattenType`<`Return`, `never`\> |
...
▸ **extractSubType**(`array`): ``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"`` \| ``"any"`` \| ``"void"``
...
``"string"`` \| ``"number"`` \| ``"boolean"`` \| ``"Block"`` \| ``"null"`` \| ``"Date"`` \| ``"Blank"`` \| ``"Record"`` \| ``"Array"`` \| ``"Error"`` \| ``"Spreadsheet"`` \| ``"Row"`` \| ``"Cell"`` \| ``"Column"`` \| ``"Range"`` \| ``"Cst"`` \| ``"Reference"`` \| ``"Function"`` \| ``"Predicate"`` \| ``"Button"`` \| ``"Switch"`` \| ``"literal"`` \| ``"Pending"`` \| ``"Waiting"`` \| ``"NoPersist"`` \| ``"any"`` \| ``"void"``
...
[packages/formula/src/tests/testHelper.ts:169](https://github.com/mashcard/mashcard/blob/main/packages/formula/src/tests/testHelper.ts#L169)
...
[packages/formula/src/tests/testHelper.ts:243](https://github.com/mashcard/mashcard/blob/main/packages/formula/src/tests/testHelper.ts#L243)
