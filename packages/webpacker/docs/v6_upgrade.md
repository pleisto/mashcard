...
Note: [Check the releases page to verify the latest version](https://github.com/rails/webpacker/releases), and make sure to install identical version numbers of webpacker gem and `@brickdoc/webpacker` npm package. (Gems use a period and packages use a dot between the main version number and the beta version.)
...
```bash
yarn add @brickdoc/webpacker@6.0.0-beta.7 --exact
```
...
"babel": {
  "presets": [
    "./node_modules/@brickdoc/webpacker/package/babel/preset.js"
  ]
}
```
