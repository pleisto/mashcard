...
describe('Base config', () => {
  ...
  describe('config', () => {
    test('should return entry', () => {
      expect(baseConfig.entry.application).toEqual(resolve('app', 'packs', 'entrypoints', 'application.js'))
    })
    ...
    test('should return output', () => {
      ...
      expect(baseConfig.output.chunkFilename).toEqual('js/[name].chunk.js')
    })
