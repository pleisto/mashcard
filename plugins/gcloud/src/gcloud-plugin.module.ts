...
import { GCSStorageAdaptorHook } from './gcs.storage-adaptor.hook'
@Module({})
export class GcloudPluginModule {
  static forRoot(): DynamicModule {
    return {
      module: GcloudPluginModule,
      providers: [GcloudConfigMap, CloudProfilerInitializerHook, CloudKMSSeedDecoderHook, GCSStorageAdaptorHook]
    }
  }
}
