...
test.describe('Switch Pod Menu', () => {
  ...
  test('Verify that create pod is working well', async ({ page }) => {
    ...
    await expect(switchPodMenu.getCurrentPodName()).toContainText(podName)
  })
